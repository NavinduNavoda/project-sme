          ...
          <div className="bg-lowwhite flex max-w-3xl items-center">
            ...
            <div className="md:w-1/2 px-8 md:px-16 py-5">
              ...
              <div className="flex flex-col gap-4">
                <input
                  className="text-[16px] border-gray-500 border-[2px] p-[10px] w-[300px] mt-[50px]"
                  type="text"
                ...
                />{" "}
                <input
                  className="text-[16px] border-gray-500 border-[2px] p-[10px] w-[300px] mt-[20px]"
                  type="text"
                ...
                />
                <button
                  className="mt-[30px] bg-accentsme py-[10px] px-[20px] text-white rounded-[2px]"
                  onClick={signUp}
                >
                  SignUp
                </button>
